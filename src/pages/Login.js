                ...
                <div className='w-[48%]'>
                    ...
                    <div className='border-[1px] border-[#ddd] p-[30px] mb-10'>
                        <div class="form-control w-full mb-[30px]">
                            ...
                            <input type="email" placeholder="Email" class="input input-bordered w-full rounded-none " />
                        </div>
                        <div class="form-control w-full mb-[30px]">
                            <label class="label">
                                <span class="text-[18px] text-left text-[#333] font-[500]">Password</span>
                            </label>
                            <input type="email" placeholder="Enter your password" class="input input-bordered w-full rounded-none " />
                        </div>
