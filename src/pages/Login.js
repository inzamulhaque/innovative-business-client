        ...
        <div>
            ...
            <div className='px-16 flex flex-col dark:bg-[#2b2b2b] lg:flex-row justify-between '>
                <div className='lg:w-[48%] w-full'>
                    ...
                    <div className='border-[1px] border-[#ddd] dark:border dark:border-gray-400 p-[30px] mb-10'>
                ...
                <div className='lg:w-[48%] w-full'>
                    ...
                    <div className='border-[1px] dark:border dark:border-gray-400 border-[#ddd] p-[30px] mb-10'>
